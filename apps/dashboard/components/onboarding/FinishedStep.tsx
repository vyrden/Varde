...
const STATUS_LABELS: Record<
  OnboardingSessionDto['status'],
  { title: string; description: string }
> = {
  draft: { title: 'Draft', description: '' },
  previewing: { title: 'Prévisualisation', description: '' },
  applying: { title: 'Application en cours', description: '' },
  applied: { title: 'Appliqué', description: '' },
  rolled_back: {
