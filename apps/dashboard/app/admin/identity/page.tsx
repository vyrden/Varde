...
export default async function AdminIdentityPage(): Promise<ReactElement> {
  ...
  const copy: AdminIdentityFormCopy = {
    ...
    avatar: {
      ...
      dropPrompt: t('form.avatar.dropPrompt'),
      remove: t('form.avatar.remove'),
      errorUnsupportedType: t('form.avatar.errorUnsupportedType'),
      errorTooLarge: t.raw('form.avatar.errorTooLarge') as string,
    },
    banner: {
      label: t('form.banner.label'),
      hint: t('form.banner.hint'),
      dropPrompt: t('form.banner.dropPrompt'),
      remove: t('form.banner.remove'),
      errorUnsupportedType: t('form.banner.errorUnsupportedType'),
      errorTooLarge: t.raw('form.banner.errorTooLarge') as string,
    },
